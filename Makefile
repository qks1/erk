...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Aug 6 12:51:08 2012
# Project:  sql.pro
# Template: app
...
SOURCES       = searcher.cpp \
		...
		input.cpp \
		mytablemodel.cpp \
		paramsselector.cpp moc_searcher.cpp \
		moc_switcher.cpp \
		moc_catalog.cpp \
		moc_table.cpp \
		moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sql1.0.0/ && $(COPY_FILE) --parents searcher.h filters.h constants.h helpers.h switcher.h catalog.h table.h mainwindow.h input.h mytablemodel.h paramsselector.h .tmp/sql1.0.0/ && $(COPY_FILE) --parents images.qrc .tmp/sql1.0.0/ && $(COPY_FILE) --parents searcher.cpp filters.cpp helpers.cpp switcher.cpp catalog.cpp constants.cpp table.cpp mainwindow.cpp main.cpp input.cpp mytablemodel.cpp paramsselector.cpp .tmp/sql1.0.0/ && (cd `dirname .tmp/sql1.0.0` && $(TAR) sql1.0.0.tar sql1.0.0 && $(COMPRESS) sql1.0.0.tar) && $(MOVE) `dirname .tmp/sql1.0.0`/sql1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sql1.0.0
...
compiler_moc_header_make_all: moc_searcher.cpp moc_switcher.cpp moc_catalog.cpp moc_table.cpp moc_mainwindow.cpp moc_input.cpp moc_mytablemodel.cpp moc_paramsselector.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_searcher.cpp moc_switcher.cpp moc_catalog.cpp moc_table.cpp moc_mainwindow.cpp moc_input.cpp moc_mytablemodel.cpp moc_paramsselector.cpp
...
moc_paramsselector.cpp: constants.h \
		helpers.h \
		paramsselector.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) paramsselector.h -o moc_paramsselector.cpp
...
paramsselector.o: paramsselector.cpp paramsselector.h \
		constants.h \
		helpers.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o paramsselector.o paramsselector.cpp
