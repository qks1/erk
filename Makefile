...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Jul 5 11:43:52 2012
# Project:  sql.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sql1.0.0/ && $(COPY_FILE) --parents searcher.h filters.h constants.h helpers.h switcher.h catalog.h table.h .tmp/sql1.0.0/ && $(COPY_FILE) --parents sql.cpp searcher.cpp filters.cpp helpers.cpp switcher.cpp catalog.cpp constants.cpp table.cpp .tmp/sql1.0.0/ && (cd `dirname .tmp/sql1.0.0` && $(TAR) sql1.0.0.tar sql1.0.0 && $(COMPRESS) sql1.0.0.tar) && $(MOVE) `dirname .tmp/sql1.0.0`/sql1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sql1.0.0
...
compiler_moc_header_make_all: moc_searcher.cpp moc_switcher.cpp moc_catalog.cpp moc_table.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_searcher.cpp moc_switcher.cpp moc_catalog.cpp moc_table.cpp
