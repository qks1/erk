...
void GreySearcher::edit_correction_slot(bool moving){
    ...
    GreyAddDialog *egd = new GreyAddDialog(id, grey_id, quantity, year, inspection, pack, storage, rack, board, box, category, addpar1, addpar2, status, moving);
